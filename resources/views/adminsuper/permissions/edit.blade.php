            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('index') }}">@lang('global.home')</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('permissions.index') }}">Ruxsatlar </a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('permissions.update',$permission->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('permissions.index') }}" class="btn btn-danger float-left">Bekor qilish</a>
                            </div>
                        </form>
